######################################################################
#
# egbk.pl - Source code filter to escape GBK
#
...
# functions of package Egbk
    ...
    elsif (m{\G \b lc \b      (?! \s* => )                    }oxgc) { $slash = 'm//'; return   'Egbk::lc';           }
    elsif (m{\G \b uc \b      (?! \s* => )                    }oxgc) { $slash = 'm//'; return   'Egbk::uc';           }
...
# functions of package Egbk
        ...
        elsif ($string =~ m{\G \b lc \b                                      }oxgc) { $e_string .=   'Egbk::lc';            $slash = 'm//'; }
        elsif ($string =~ m{\G \b uc \b                                      }oxgc) { $e_string .=   'Egbk::uc';            $slash = 'm//'; }
...
=head1 SYNOPSIS
  ...
  C:\>perl egbk.pl GBK_script.pl > Escaped_script.pl.e
...
The GBK was developed in order to maintain backward compatibility. In general,
...
=head1 SOFTWARE COMPOSITION
    ...
    jperl55.bat  --- jperl emulator by perl5.5 with egbk.pl
    jperl58.bat  --- jperl emulator by perl5.8 with egbk.pl
    perl58.bat   --- find and run perl5.8 without %PATH% settings
    jperl510.bat --- jperl emulator by perl5.10 with egbk.pl
    perl510.bat  --- find and run perl5.10 without %PATH% settings
    egbk.pl     --- source code filter to escape GBK
    Egbk.pm     --- run-time routines for egbk.pl
    GBK.pm      --- Source code filter for GBK script
...
=item * COMBINATION #1
    ...
    egbk.pl + Egbk.pm
    source code filter to escape GBK

=item * COMBINATION #2

    jperl55.bat + egbk.pl + Egbk.pm
    jperl emulator by perl5.5 with egbk.pl, Egbk.pm (I)

=item * COMBINATION #3

    GBK.pm + egbk.pl + Egbk.pm
    jperl emulator by perl with egbk.pl, Egbk.pm (II)

=item * COMBINATION #4

    jperl58.bat + perl58.bat + egbk.pl + Egbk.pm
    jperl emulator by perl5.8 with egbk.pl, Egbk.pm without %PATH% settings (I)

=item * COMBINATION #5

    perl58.bat + GBK.pm + egbk.pl + Egbk.pm
    jperl emulator by perl5.8 with egbk.pl, Egbk.pm without %PATH% settings (II)

=item * COMBINATION #6

    jperl510.bat + perl510.bat + egbk.pl + Egbk.pm
    jperl emulator by perl5.10 with egbk.pl, Egbk.pm without %PATH% settings (I)

=item * COMBINATION #7

    perl510.bat + GBK.pm + egbk.pl + Egbk.pm
    jperl emulator by perl5.10 with egbk.pl, Egbk.pm without %PATH% settings (II)
...
This egbk.pl software first appeared in ActivePerl Build 522 Built under
