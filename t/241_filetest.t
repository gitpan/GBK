...
$_ = 'file';
if ((Egbk::k_ ne '') == (-k ne '')) {
    print "ok - 20 Egbk::k_ == -k  $^X $__FILE__\n";
}
else {
    print "not ok - 20 Egbk::k_ == -k  $^X $__FILE__\n";
}

$_ = 'file';
if ((Egbk::T_ ne '') == (-T ne '')) {
    print "ok - 21 Egbk::T_ == -T  $^X $__FILE__\n";
}
else {
    print "not ok - 21 Egbk::T_ == -T  $^X $__FILE__\n";
}

$_ = 'file';
if ((Egbk::B_ ne '') == (-B ne '')) {
    print "ok - 22 Egbk::B_ == -B  $^X $__FILE__\n";
}
else {
    print "not ok - 22 Egbk::B_ == -B  $^X $__FILE__\n";
}

$_ = 'file';
if ((Egbk::M_ ne '') == (-M ne '')) {
    print "ok - 23 Egbk::M_ == -M  $^X $__FILE__\n";
}
else {
    print "not ok - 23 Egbk::M_ == -M  $^X $__FILE__\n";
}

$_ = 'file';
if ((Egbk::A_ ne '') == (-A ne '')) {
    print "ok - 24 Egbk::A_ == -A  $^X $__FILE__\n";
}
else {
    print "not ok - 24 Egbk::A_ == -A  $^X $__FILE__\n";
}

$_ = 'file';
if ((Egbk::C_ ne '') == (-C ne '')) {
    print "ok - 25 Egbk::C_ == -C  $^X $__FILE__\n";
}
else {
    print "not ok - 25 Egbk::C_ == -C  $^X $__FILE__\n";
}
