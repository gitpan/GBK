...
# functions of package Egbk
    ...
    elsif (m{\G \b split (\s* \( \s*) m\s*(\S)\2              }oxgc) { $slash = 'm//'; return   "Egbk::split$1''";    }
    elsif (m{\G \b split (\s* \( \s*) //                      }oxgc) { $slash = 'm//'; return   "Egbk::split$1''";    }
    elsif (m{\G \b split (\s+)        m\s*(\S)\2              }oxgc) { $slash = 'm//'; return   "Egbk::split$1''";    }
    elsif (m{\G \b split (\s*)        //                      }oxgc) { $slash = 'm//'; return   "Egbk::split$1''";    }
    elsif (m{\G \b split (\s* \( \s*) m\s*(\S)([ -?]\+?)\2    }oxgc) { $slash = 'm//'; return qq{Egbk::split$1 q{$3}};}
    elsif (m{\G \b split (\s* \( \s*) /([ -?]\+?)/            }oxgc) { $slash = 'm//'; return qq{Egbk::split$1 q{$2}};}
    elsif (m{\G \b split (\s+)        m\s*(\S)([ -?]\+?)\2    }oxgc) { $slash = 'm//'; return qq{Egbk::split$1 q{$3}};}
    elsif (m{\G \b split (\s*)        /([ -?]\+?)/            }oxgc) { $slash = 'm//'; return qq{Egbk::split$1 q{$2}};}
    elsif (m{\G \b split (\s* \( \s*) m\s*(\S)(\\[nrtf]\+?)\2 }oxgc) { $slash = 'm//'; return qq{Egbk::split$1"$3"};  }
    elsif (m{\G \b split (\s* \( \s*) /(\\[nrtf]\+?)/         }oxgc) { $slash = 'm//'; return qq{Egbk::split$1"$2"};  }
    elsif (m{\G \b split (\s+)        m\s*(\S)(\\[nrtf]\+?)\2 }oxgc) { $slash = 'm//'; return qq{Egbk::split$1"$3"};  }
    elsif (m{\G \b split (\s*)        /(\\[nrtf]\+?)/         }oxgc) { $slash = 'm//'; return qq{Egbk::split$1"$2"};  }
    elsif (m{\G \b split \b   (?! \s* => )                    }oxgc) { $slash = 'm//'; return   'Egbk::split';        }
                         ...
                         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $slash = 'm//'; return   "Egbk::$1";           }
    ...
    elsif (m{\G \b ord   (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $slash = 'div'; return   'Egbk::ord';          }
    ...
    elsif (m{\G \b ord \b     (?! \s* => )                    }oxgc) { $slash = 'div'; return   'Egbk::ord_';         }
    elsif (m{\G \b glob \b    (?! \s* => )                    }oxgc) { $slash = 'm//'; return   'Egbk::glob_';        }
    elsif (m{\G \b reverse \b (?! \s* => )                    }oxgc) { $slash = 'm//'; return   'Egbk::reverse';      }
...
# functions of package Egbk
        ...
        elsif ($string =~ m{\G \b split (\s* \( \s*) m\s*(\S)\2              }oxgc) { $e_string .=   "Egbk::split$1''";     $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s* \( \s*) //                      }oxgc) { $e_string .=   "Egbk::split$1''";     $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s+)        m\s*(\S)\2              }oxgc) { $e_string .=   "Egbk::split$1''";     $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s*)        //                      }oxgc) { $e_string .=   "Egbk::split$1''";     $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s* \( \s*) m\s*(\S)([ -?]\+?)\2    }oxgc) { $e_string .= qq{Egbk::split$1 q{$3}}; $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s* \( \s*) /([ -?]\+?)/            }oxgc) { $e_string .= qq{Egbk::split$1 q{$2}}; $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s+)        m\s*(\S)([ -?]\+?)\2    }oxgc) { $e_string .= qq{Egbk::split$1 q{$3}}; $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s*)        /([ -?]\+?)/            }oxgc) { $e_string .= qq{Egbk::split$1 q{$2}}; $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s* \( \s*) m\s*(\S)(\\[nrtf]\+?)\2 }oxgc) { $e_string .= qq{Egbk::split$1"$3"};   $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s* \( \s*) /(\\[nrtf]\+?)/         }oxgc) { $e_string .= qq{Egbk::split$1"$2"};   $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s+)        m\s*(\S)(\\[nrtf]\+?)\2 }oxgc) { $e_string .= qq{Egbk::split$1"$3"};   $slash = 'm//'; }
        elsif ($string =~ m{\G \b split (\s*)        /(\\[nrtf]\+?)/         }oxgc) { $e_string .= qq{Egbk::split$1"$2"};   $slash = 'm//'; }
        elsif ($string =~ m{\G \b split \b                                   }oxgc) { $e_string .=   'Egbk::split';         $slash = 'm//'; }
                                        ...
                                        (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $e_string .=   "Egbk::$1";            $slash = 'm//'; }
        ...
        elsif ($string =~ m{\G \b ord   (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) }oxgc) { $e_string .=   'Egbk::ord';           $slash = 'div'; }
        ...
        elsif ($string =~ m{\G \b ord \b                                     }oxgc) { $e_string .=   'Egbk::ord_';          $slash = 'div'; }
        elsif ($string =~ m{\G \b glob \b                                    }oxgc) { $e_string .=   'Egbk::glob_';         $slash = 'm//'; }
        elsif ($string =~ m{\G \b reverse \b                                 }oxgc) { $e_string .=   'Egbk::reverse';       $slash = 'm//'; }
...
=item * Handling raw GBK values

=item * Handling real length of GBK string
...
=item * COMBINATION #1
    ...
    GBK.pm + Egbk.pm
    jperl emulator by perl with Egbk.pm

=item * COMBINATION #2

    perl58.bat + GBK.pm + Egbk.pm
    jperl emulator by perl5.8 with Egbk.pm without %PATH% settings

=item * COMBINATION #3

    perl510.bat + GBK.pm + Egbk.pm
    jperl emulator by perl5.10 with Egbk.pm without %PATH% settings
